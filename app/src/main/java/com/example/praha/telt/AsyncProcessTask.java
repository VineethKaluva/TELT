...
public class AsyncProcessTask extends AsyncTask<String, String, Boolean> {
    ...
    Context context;
    public AsyncProcessTask(TextExtraction activity) {
    ...
    /** application context. */
    private final TextExtraction activity;
       ...
       // String language = args[2];
        ...
        try {
            Client restClient = new Client();
                   ...
                   // restClient.applicationId = "Text Extraction and Language Translation";

            // You should get e-mail from ABBYY Cloud OCR SDK service with the application password
            //restClient.password = "0Nl1fjLsMpVJmEzdNol9xJBP";
            restClient.applicationId = "TextExtraction2";
            restClient.password = "n1M7x1022GrdQUTpf3WyEwrA";
            ...
            String language = "English,Spanish,Russian,Japanese,French,German,Italian,Korean";
            // Comma-separated list: Japanese,English or German,French,Spanish etc.


          //  String language = MainActivity.result;
          //  Log.i(Tag,language);
         //   Toast.makeText(context.getApplicationContext(),"Language is "+language,Toast.LENGTH_LONG).show();
